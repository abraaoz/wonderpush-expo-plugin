...
import { xcodeProjectAddNse } from './wonderpush/withWonderPushIos'
...
// 4. Run `node ~/WHERE_YOU_CLONED_ME/wonderpush-expo-plugin/build/testRuniOS.js`
...
const options = {
  iosPath: ".",
  mode: Mode.Dev,
  bundleIdentifier: "com.wonderpush.XcodeTestProj",
  devTeam: "99SW8E36CT",
...
xcodeProjectAddNse(
  "XcodeTestProj",
  options,
  "../../repos/wonderpush-expo-plugin/support/serviceExtensionFiles/",
)
